import { JustJoinItDetailedJobOffer, JustJoinItJobApiResponse } from './just-join-it.ts';
...
export type SeekJobRequest<T extends SeekSources> = Omit<SeekJobSettings<'one'>, 'seekSource'> & SeekJobParamsMap[T];
...
export type SeekJobSettings<T extends SeekSourceMode = "many"> = T extends 'many' ?
  {
